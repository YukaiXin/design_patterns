...
import strategyPattern.strategyFactory.bean.CalPrice;
 ...
 */
public class CalPriceFactoryAno {

    private static final String CAL_PRICE_PACKAGE = "strategyPattern.strategyFactory.bean";//这里是一个常量，表示我们扫描策略的包
    ...
    public static CalPriceFactoryAno getInstance() {
        return CalPriceFactoryInstance.instance;
    }

    private static class CalPriceFactoryInstance {

        private static CalPriceFactoryAno instance = new CalPriceFactoryAno();
    }
